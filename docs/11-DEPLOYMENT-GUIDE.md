...
SKALE_PRIVATE_KEY=0x[64_HEX_CHARS]
SKALE_AUDIT_CONTRACT=0x[40_HEX_CHARS]
...
SKALE_RPC_URL=https://testnet.skalenodes.com/v1/CHAIN_NAME
SKALE_PRIVATE_KEY=0x$(openssl rand -hex 32)
SKALE_AUDIT_CONTRACT=0x0000000000000000000000000000000000000000
