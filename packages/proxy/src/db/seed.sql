...
INSERT INTO endpoint_scores (endpoint, category, overall_score, cost_score, latency_score, reliability_score, evidence) VALUES
  ...
  -- Content & Media (2) — diverse content generators
  ...
  ('x402-ai-starter-alpha.vercel.app',           'Developer Tools', 90.00, 92.00, 94.00, 96.00, '{"sampleSize": 2000, "period": "30d", "avgCostPerRequest": "5000", "avgLatencyMs": 95, "successRate": 0.998, "network": "base-sepolia", "resourceCount": 1}'),
...
INSERT INTO requests (project_id, endpoint, full_url, method, status_code, cost, cached, latency_ms, policy_id, created_at) VALUES
  ...
  ('00000000-0000-0000-0000-000000000010', 'x402-ai-starter-alpha.vercel.app', 'https://x402-ai-starter-alpha.vercel.app/api/add', 'POST', 200, 5000, false, 95, '00000000-0000-0000-0000-000000000100', NOW() - INTERVAL '6 days 2 hours'),
  -- Day -5
  ...
  ('00000000-0000-0000-0000-000000000010', 'x402-ai-starter-alpha.vercel.app', 'https://x402-ai-starter-alpha.vercel.app/api/add', 'POST', 200, 5000, false, 90, '00000000-0000-0000-0000-000000000100', NOW() - INTERVAL '1 day 2 hours'),
